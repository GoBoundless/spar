...
Gem::Specification.new do |s|
  ...
  s.description = %q{Spar uses Sprockets and Sinatra to provide an asset development environment very similar to the asset pipeline found in Rails. It allows you to use all the awesome features of the asset pipeline without all the heft of Rails which isn't needed for single page web apps.}
  ...
  s.add_dependency "haml_coffee_assets", '~> 0.6',  '>= 0.6.1'
